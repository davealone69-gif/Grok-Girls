...
> `PbrTexture.kt`/`GltfTextures.kt` (upload semantics, units 0..4,
> `uHas*Map` flags), and the avatar fragment shader mirrors `HdPbrShader.kt`
> sampling (pow-2.2 base color, MR G=roughness/B=metallic, TBN normals).
