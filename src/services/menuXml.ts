 ...
 *
 * The app previously had two competing menu sources: public/menu.xml and this
 * TypeScript fallback. That made stale/partial XML capable of reintroducing
 * duplicate controls. Navigation is now owned by this single model.
 */
...
/** Kept for compatibility with existing imports. XML is intentionally no longer authoritative. */
