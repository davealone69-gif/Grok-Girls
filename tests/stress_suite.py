...
with sync_playwright() as p:
    ...
    pg.locator(".rail-btn[title='Interactive Dialogue'], button:has-text('Chat')").click()
    ...
    t0 = time.time()
    pg.locator(".rail-btn[title='Generation Archive'], button:has-text('Gallery')").click()
    ...
    pg.locator(".btn-send-chat").click()
    pg.wait_for_timeout(400)
    pg.locator(".rail-btn[title='Preset Identities'], button:has-text('Builder')").click()
    pg.wait_for_timeout(300)
